    ...
    <div class="px-4 sm:px-6 lg:px-8 pb-5">
        <div data-hs-carousel='{
            ...
            <div class="hs-carousel relative overflow-hidden w-full h-120 md:h-[calc(100vh-250px)]  bg-gray-100 rounded-2xl dark:bg-neutral-800">
                ...
                @foreach ($this->getFtProds as $getFtProd)
                <!-- Item -->
                ...
                <div class="flex justify-between items-center gap-x-4">
                    @foreach ($this->getBrands as $brand )
                        <div class="flex-shrink-0">
                            <a href="#!" class="block">
                                <img src="{{ Storage::url($brand['brand_image']) }}" alt="{{ $brand['brand_name'] }}" class="w-14 md:w-14 h-auto mx-auto object-cover">
                            </a>
                        </div>
                    @endforeach
                </div>
                            ...
                            <div class="p-4 md:p-0 mb-4">
                                ...
                                <div class="flex flex-row items-center justify-start mt-3 align-middle">
                                    ...
                                    @else
                                        {{-- No discount --}}
                                        <div>
                                            <span class="text-gray-500 dark:text-white font-bold">₱{{ number_format($product->prod_price, 2) }}</span>
                                        </div>
                                    @endif
