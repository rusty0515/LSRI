        ...
        <div class="grid grid-flow-row-dense grid-cols-3 grid-rows-1 md:gap-x-6 h-auto">
            ...
            <div class="col-span-3 md:col-span-1">
                <div class="flex flex-col gap-y-6">
                    ...
                    <div class="mt-2">
                        <button  wire:click="checkout" wire:loading.attr="disabled"  class="inline-block w-full px-5 py-3 text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:bg-red-700 rounded-lg inline-flex items-center gap-x-2 text-center align-middle justify-center">
