<div>
        ...
        <div class="mt-3">
            ...
            <div id="segment-2" class="hidden" role="tabpanel" aria-labelledby="segment-item-2">
                ...
                <div
                    ...
                    <button type="button" aria-haspopup="dialog" aria-expanded="false"
                        aria-controls="request-modal" data-hs-overlay="#request-modal"
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-red-500 border border-transparent rounded-lg gap-x-2 hover:bg-red-600 focus:outline-none focus:bg-red-600 disabled:opacity-50 disabled:pointer-events-none">
                    ...
                    <div class="border-e-2 border-gray-200 dark:border-neutral-700">
                        <nav class="flex flex-col space-y-2 md:space-y-4 lg:space-y-5" aria-label="Tabs"
                            ...
                            <button type="button"
                                class="hs-tab-active:border-red-500 hs-tab-active:text-red-600 dark:hs-tab-active:text-red-600 py-1 pe-4 inline-flex items-center gap-x-2 border-e-2 border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-red-600 focus:outline-hidden focus:text-red-600 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:text-red-500 active"
                                id="vertical-tab-with-border-item-1" aria-selected="true"
                                data-hs-tab="#request-vertical-tab-with-border-1"
                                aria-controls="vertical-tab-with-border-1" role="tab">
                            ...
                            <button type="button"
                                class="hs-tab-active:border-green-500 hs-tab-active:text-green-600 dark:hs-tab-active:text-green-600 py-1 pe-4 inline-flex items-center gap-x-2 border-e-2 border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-green-600 focus:outline-hidden focus:text-green-600 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:text-green-500"
                                id="vertical-tab-with-border-item-3" aria-selected="false"
                                data-hs-tab="#request-vertical-tab-with-border-3"
                                aria-controls="vertical-tab-with-border-3" role="tab">
            ...
            <div id="segment-3" class="hidden" role="tabpanel" aria-labelledby="segment-item-3">
                ...
                <div
                    ...
                    <button type="button" aria-haspopup="dialog" aria-expanded="false"
                        aria-controls="new-vehicle-modal" data-hs-overlay="#new-vehicle-modal"
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-red-500 border border-transparent rounded-lg gap-x-2 hover:bg-red-600 focus:outline-none focus:bg-red-600 disabled:opacity-50 disabled:pointer-events-none">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                        <tr>
                            <td
                                class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 text-start">
                                Car</td>
                            <td
                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200 text-start">
                                Toyota</td>
                            <td
                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200 text-start">
                                Corolla</td>
                            <td
                                class="px-6 py-4 text-sm text-gray-800 dark:text-neutral-200 whitespace-normal break-words max-w-xs text-start">
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam totam porro ipsum
                                    culpa quos facilis?</p>
                            </td>
    ...
    <div id="new-vehicle-modal"
        ...
        role="dialog" tabindex="-1" aria-labelledby="new-vehicle-modal-label">
        <div class="sm:max-w-lg sm:w-full m-3 sm:mx-auto">
            <div
                ...
                <div
                    ...
                    <h3 id="new-vehicle-modal-label" class="font-bold text-gray-800 dark:text-white">
                        New Vehicle
                    </h3>
                    <button type="button"
                        class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-hidden focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600"
                        aria-label="Close" data-hs-overlay="#new-vehicle-modal">
                ...
                <div class="p-4 overflow-y-auto">
                    ...
                    <div class="px-4 sm:px-6 lg:px-8 mx-auto">
                        <div class="mx-auto max-w-2xl">
                            ...
                            <!-- Card -->
                            <div class="my-5 relative z-10 bg-transparent">
                                <div class="mb-4 sm:mb-5">
                                    <label for="vehicle"
                                        class="block mb-2 text-sm font-medium dark:text-white">{{ __('Select Vehicle') }}</label>
                                    <select id="vehicle"
                                        class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-red-500 focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                ...
                                <!-- Grid -->
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 mb-4 sm:mb-5">

                                    <div>
                                        <label for="brand"
                                            class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">{{ __('Brand') }}</label>
                                    ...
                                    <div>
                                        <label for="model"
                                            class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">{{ __('Model') }}</label>
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        data-hs-overlay="#new-vehicle-modal">
                        Close
                    </button>
                    <button type="button"
    ...
    <div id="request-modal"
        class="hs-overlay hs-overlay-open:opacity-100 hs-overlay-open:duration-500 hidden size-full fixed top-0 start-0 z-80 opacity-0 overflow-x-hidden transition-all overflow-y-auto pointer-events-none"
        role="dialog" tabindex="-1" aria-labelledby="request-modal-label">
        <div class="sm:max-w-lg sm:w-full md:max-w-2xl md:w-full m-3 sm:mx-auto">
            <div
                class="flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                <div
                    class="flex justify-between items-center py-3 px-4 border-b border-gray-200 dark:border-neutral-700">
                    <h3 id="request-modal-label" class="font-bold text-gray-800 dark:text-white">
                        {{ __('New Request') }}
                    </h3>
                    <button type="button"
                        class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-hidden focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600"
                        aria-label="Close" data-hs-overlay="#request-modal">
                        <span class="sr-only">Close</span>
                        <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="mx-auto max-w-2xl">
                            ...
                            <div class="my-5 relative z-10 bg-transparent">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 mb-4 sm:mb-5">
                                    ...
                                    <div>
                                        <label for="mechanic"
                                            class="block mb-2 text-sm font-medium dark:text-white">{{ __('Select Mechanic') }}</label>
                                        <select id="mechanic"
                                            class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-red-500 focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 mb-4 sm:mb-5">
                                    ...
                                    <div>
                                        <label for="request-date-input"
                                            class="block text-sm font-medium mb-2 dark:text-white">{{ __('Resquested Date') }}</label>
                                        <div class="relative">
                                            <input type="date" id="request-date-input" name="request-date-input"
                                ...
                                <div>
                                    <label for="description"
                                        class="block mb-2 text-sm font-medium dark:text-white">{{ __('Message') }}</label>
                                    <div class="mt-1">
                                        <textarea id="description" name="description" rows="5"
                                            class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-red-500 focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
