<div>
    <div class="max-w-[60rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-12 mx-auto">
        ...
        <div class="text-center mx-auto mb-5">
            <h2
                class="text-2xl text-gray-800 dark:text-white flex flex-row gap-x-2 items-center align-middle justify-center">
                ...
                <div class="flex">
                    <div class="border-e-2 border-gray-200 dark:border-neutral-700">
                        <nav class="flex flex-col space-y-2 md:space-y-4 lg:space-y-5" aria-label="Tabs" role="tablist"
                            ...
                            @foreach (['in_progress' => ['icon' => 'M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99', 'label' => 'In Progress'], 'shipped' => ['icon' => 'M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12', 'label' => 'Shipped'], 'delivered' => ['icon' => 'm21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9', 'label' => 'Delivered'], 'cancelled' => ['icon' => 'm9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z', 'label' => 'Cancelled']] as $tab => $config)
                    ...
                    <div class="ms-3 w-full">
                                            ...
                                            <tr wire:key="orders-{{ $order->id }}">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                    <div class="flex flex-col space-y-2">
                                                        <button type="button"
                                                            wire:click="openOrderDetails({{ $order->id }})"
                                                            class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                                                        ...
                                                        @if (
                                                            $order->order_status === \App\Enums\OrderStatusEnum::New ||
                                                                $order->order_status === \App\Enums\OrderStatusEnum::Processing)
                                                            <button type="button"
                                                                wire:click="cancelOrder({{ $order->id }})"
                                                                wire:confirm="Are you sure you want to cancel this order?"
                                                                class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 transition-colors">
                        ...
                        @else
                            <div class="text-center py-8">
                                <svg class="mx-auto size-12 text-gray-400 dark:text-neutral-600" fill="none"
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-neutral-400">Get started by creating a
                                    new order.</p>
                            </div>
                        @endif
                    </div>
                ...
                <div class="flex">
                    <div class="border-e-2 border-gray-200 dark:border-neutral-700">
                        <nav class="flex flex-col space-y-2 md:space-y-4 lg:space-y-5" aria-label="Tabs"
                            ...
                            @foreach (['pending' => ['icon' => 'M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z', 'label' => 'Pending'], 'in_progress' => ['icon' => 'M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99', 'label' => 'In Progress'], 'completed' => ['icon' => 'm4.5 12.75 6 6 9-13.5', 'label' => 'Completed'], 'cancelled' => ['icon' => 'm9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z', 'label' => 'Cancelled']] as $tab => $config)
                    ...
                    <div class="ms-3 w-full">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No service requests
                                </h3>
                                <p class="mt-1 text-sm text-gray-500 dark:text-neutral-400">Get started by creating a
            ...
            @elseif($activeSegment === 'vehicles')
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <div class="flex items-center gap-2">
                                                @if ($vehicle['type'] === 'car')
                                                    <svg class="size-5 text-blue-600" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="1.5"
                                                ...
                                                @elseif($vehicle['type'] === 'motorcycle')
                                                    <svg class="size-5 text-green-600" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="1.5" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                                                    </svg>
                                                @else
                                                    <svg class="size-5 text-yellow-600" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="1.5"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <button type="button"
                                                wire:click="deleteVehicle('{{ $vehicle['type'] }}', '{{ $vehicle['remarks'] }}')"
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-neutral-400">Get started by creating a service
                            request for your vehicle.</p>
                        <button type="button" wire:click="openRequestModal"
                            class="mt-4 inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-lg hover:bg-red-700">
    ...
    @if ($showOrderDetailsModal)
        <div class="fixed inset-0 z-50 overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                <div class="fixed inset-0 transition-opacity backdrop-blur bg-opacity-10"
                    wire:click="closeOrderDetailsModal"></div>

                <span class="hidden sm:inline-block sm:align-middle sm:h-screen">&#8203;</span>

                <div
                    class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full sm:p-6 dark:bg-neutral-800">
                    <!-- Modal header -->
                    <div
                        class="flex items-center justify-between pb-3 border-b border-gray-200 dark:border-neutral-700">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                                Order Details - {{ $selectedOrder->order_number ?? '' }}
                            </h3>
                            <p class="text-sm text-gray-500 dark:text-neutral-400 mt-1">
                                Placed on {{ $selectedOrder->created_at->format('F j, Y') ?? '' }}
                            </p>
                        </div>
                        <button type="button" wire:click="closeOrderDetailsModal"
                    ...
                    <div class="space-y-6 mt-4">
                        ...
                        {{-- <div class="flex items-center justify-between">
                            <div>
                                <h4 class="text-sm font-medium text-gray-900 dark:text-white">Order Status</h4>
                                <p class="text-sm text-gray-500 dark:text-neutral-400">Current status of your order</p>
                            </div>
                            <span
                                class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-800/30 dark:text-blue-500">
                                {{ $selectedOrder->order_status->getLabel() ?? '' }}
                            </span>
                        </div> --}}
                        ...
                        @if ($showOrderDetailsModal)
                            <div class="fixed inset-0 z-50 overflow-y-auto">
                                            ...
                                            {{-- <div class="flex items-center justify-between">
                                                <div>
                                                    <h4 class="text-sm font-medium text-gray-900 dark:text-white">Order
                                                        Status</h4>
                                                    <p class="text-sm text-gray-500 dark:text-neutral-400">Current
                                                ...
                                                <div
                                                    ...
                                                    <table
                                                        ...
                                                        <thead class="bg-gray-50 dark:bg-neutral-700">
                                                            <tr>
                                                                <th scope="col"
                                                                    class="px-4 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-400">
                                                                    Product</th>
                                                                <th scope="col"
                                                                    class="px-4 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-400">
                                                                    Unit Price</th>
                                                                <th scope="col"
                                                                    ...
                                                                    Quantity</th>
                                                                <th scope="col"
                                                                    class="px-4 py-3 text-end text-xs font-medium text-gray-500 uppercase dark:text-neutral-400">
                                                                    Subtotal</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody
                                                            class="divide-y divide-gray-200 dark:divide-neutral-700">
                                                            @if ($selectedOrder && $selectedOrder->orderItems && $selectedOrder->orderItems->count() > 0)
                                                                @foreach ($selectedOrder->orderItems as $item)
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            class="px-4 py-3 whitespace-nowrap text-sm text-gray-900 dark:text-white text-end">
                                                            ...
                                                            @else
                                                                <tr>
                                                                    <td colspan="4"
                                                                        class="px-4 py-4 text-center text-sm text-gray-500 dark:text-neutral-400">
                                            ...
                                            <div class="border-t border-gray-200 dark:border-neutral-700 pt-4">
                                                <div class="space-y-2">
                                                    <div class="flex justify-between text-sm">
                                                        <span
                                                            class="text-gray-600 dark:text-neutral-400">Subtotal</span>
                                                        <span class="text-gray-900 dark:text-white">
                                                            ₱{{ number_format($selectedOrder->order_total_price, 2) }}
                                                        </span>
                                                    </div>
                                                    <div class="flex justify-between text-sm">
                                                        <span
                                                            class="text-gray-600 dark:text-neutral-400">Shipping</span>
                                                        <span
                                                            class="text-gray-900 dark:text-white">₱{{ number_format($selectedOrder->shipping_price, 2) }}</span>
                                                    </div>
                                                    {{-- <div class="flex justify-between text-sm">
                                ...
                                <span class="text-gray-900 dark:text-white">₱0.00</span>
                                                    ...
                                                    <div class="flex justify-between text-sm">
                                                        <span
                                                            class="text-gray-600 dark:text-neutral-400 flex items-center gap-1">
                                                            Tax (12% VAT included)
                                                        ...
                                                        <span
                                                            class="text-gray-900 dark:text-white">₱{{ number_format($selectedOrder->order_total_price, 2) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="bg-gray-50 dark:bg-neutral-700 rounded-lg p-4">
                                                    @if ($selectedOrder && $selectedOrder->addresses && $selectedOrder->addresses->count() > 0)
                                                        @php
                                                            $primaryAddress = $selectedOrder->addresses->first();
                                                        @endphp
                                                        <div class="flex items-start justify-between">
                                                            <div class="flex-1">
                                                                ...
                                                                {{-- <p class="text-sm text-gray-600 dark:text-neutral-400">
                                                                    ...
                                                                    @endif
                                                                    @if ($primaryAddress->philippineBarangay)
                                                                        {{ $primaryAddress->philippineBarangay->barangay_description }},
                                                                    @endif
                                                                    @if ($primaryAddress->philippineCity)
                                                                        {{ $primaryAddress->philippineCity->city_municipality_description }},
                                                                    @endif
                                                                    @if ($primaryAddress->philippineProvince)
                                                                        {{ $primaryAddress->philippineProvince->province_description }},
                                                                    @endif
                                                                    @if ($primaryAddress->philippineRegion)
                                                                        {{ $primaryAddress->philippineRegion->region_description }}
                                                                    @endif
                                                                </p> --}}
                                                            ...
                                                            {{-- <span
                                                                class="inline-flex items-center gap-x-1.5 py-1 px-2 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-800/30 dark:text-green-500 ml-2">
                                                                Primary
                                                            </span> --}}
                                                        </div>
                                                    @else
                                                        <p class="text-sm text-gray-600 dark:text-neutral-400">
                                                            No shipping address found for this order. Your order will be
                                            ...
                                            <!-- Modal footer -->
                                            <div
                                                class="flex justify-end gap-3 mt-6 border-t border-gray-200 dark:border-neutral-700 pt-4">
                                                <button type="button" wire:click="closeOrderDetailsModal"
                                                ...
                                                @if ($selectedOrder && in_array($selectedOrder->order_status, ['new', 'processing']))
                                                    <button type="button"
                                                        wire:click="cancelOrder({{ $selectedOrder->id }})"
                                                        class="px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-lg hover:bg-red-700 focus:outline-none focus:bg-red-700">
                                                        Cancel Order
                                                    </button>
                                                @endif
                                            </div>
                        ...
                        {{-- <div class="border-t border-gray-200 dark:border-neutral-700 pt-4">
                            <div class="space-y-2">
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="text-gray-900 dark:text-white">
                                        ₱{{ number_format($selectedOrder->order_total_price ?? 0, 2) }}
                                    </span>
                                </div>
                                <div class="flex justify-between text-sm">
                                ...
                                <div class="flex justify-between text-base font-medium border-t border-gray-200 dark:border-neutral-700 pt-2">
                        ...
                        <!-- Shipping Information -->
                        <div>
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-2">Shipping Information
                            </h4>
                            <div class="bg-gray-50 dark:bg-neutral-700 rounded-lg p-4">
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    Your order will be shipped to your registered address. You will receive a
                                    notification once your order has been shipped.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Modal footer -->
                    <div class="flex justify-end gap-3 mt-6 border-t border-gray-200 dark:border-neutral-700 pt-4">
                        <button type="button" wire:click="closeOrderDetailsModal"
                            class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-neutral-700 dark:text-white dark:border-neutral-600 dark:hover:bg-neutral-600">
                            Close
                        </button>
                        @if ($selectedOrder && in_array($selectedOrder->order_status, ['new', 'processing']))
                            <button type="button" wire:click="cancelOrder({{ $selectedOrder->id }})"
                                class="px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-lg hover:bg-red-700 focus:outline-none focus:bg-red-700">
                                Cancel Order
                            </button>
                        @endif
    ...
    @if ($showRequestModal === true)
        <div class="fixed inset-0 z-50 overflow-y-auto">
            ...
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                <div class="fixed inset-0 transition-opacity backdrop-blur bg-opacity-10"
                    wire:click="closeRequestModal"></div>

                <span class="hidden sm:inline-block sm:align-middle sm:h-screen">&#8203;</span>

                <div
                    class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6 dark:bg-neutral-800">
                    <!-- Modal header -->
                ...
                <div class="mb-4">
                    ...
                    @if (session()->has('error'))
                        <div class="bg-red-50 border border-red-200 rounded-lg p-3 dark:bg-red-900/20 dark:border-red-800">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                @foreach (['car' => 'Car', 'motorcycle' => 'Motorcycle', 'other' => 'Other'] as $value => $label)
                                    <label
                                        class="flex flex-col items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 dark:border-neutral-700 dark:hover:bg-neutral-700 cursor-pointer {{ $selectedVehicleType === $value ? 'bg-red-50 border-red-200 dark:bg-red-900/20 dark:border-red-800' : '' }}">
                                        <input type="radio" wire:model.live="selectedVehicleType"
                                            value="{{ $value }}"
                                        ...
                                        <span
                                            class="mt-2 text-sm font-medium text-gray-800 dark:text-white">{{ $label }}</span>
                                    </label>
                                @endforeach
                            </div>
                        ...
                        @if ($selectedVehicleType === 'other')
                            <div class="grid grid-cols-2 gap-4 transition-all duration-300 ease-in-out" x-data
                                x-transition>
                                <div>
                                    <label for="vehicleBrand"
                                        class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Brand</label>
                                ...
                                <div>
                                    <label for="vehicleModel"
                                        class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Model</label>
                        ...
                        <!-- Mechanic Selection -->
                        <div>
                            <label for="selectedMechanic"
                                class="block mb-2 text-sm font-medium dark:text-white">Select Mechanic</label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="requestedDate"
                                    class="block mb-2 text-sm font-medium dark:text-white">Requested Date</label>
                                <input type="date" id="requestedDate" wire:model="requestedDate" required
                            ...
                            <div>
                                <label for="scheduledDate"
                                    class="block mb-2 text-sm font-medium dark:text-white">Scheduled Date</label>
                                <input type="date" id="scheduledDate" wire:model="scheduledDate" required
                                    min="{{ now()->format('Y-m-d') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500 dark:bg-neutral-800 dark:border-neutral-600 dark:text-white">
                                @error('scheduledDate')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                        ...
                        <div>
                            ...
                            <div class="space-y-2 max-h-60 overflow-y-auto">
                                @foreach ($services as $service)
                                    <label
                                        class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 dark:border-neutral-700 dark:hover:bg-neutral-700 cursor-pointer">
                        ...
                        <!-- Additional Notes -->
                        <div>
                            <label for="message" class="block mb-2 text-sm font-medium dark:text-white">Additional
                                Notes</label>
                    ...
                    <div class="flex justify-end gap-3 mt-6">
                        <button type="button" wire:click="closeRequestModal" wire:loading.attr="disabled"
                            class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-neutral-700 dark:text-white dark:border-neutral-600 dark:hover:bg-neutral-600">
                            Cancel
                        </button>
